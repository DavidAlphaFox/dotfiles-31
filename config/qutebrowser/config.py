...
# Type: Font
c.fonts.completion.entry = '10pt "JetBrainsMonoNL Nerd Font"'

# Font used for the debugging console.
# Type: Font
c.fonts.debug_console = '10pt "JetBrainsMonoNL Nerd Font"'

# Font used for prompts.
# Type: Font
c.fonts.prompts = 'default_size JetBrainsMonoNL Nerd Font'
